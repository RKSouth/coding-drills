...
var dog = "Bentley Christmas Present";
...
cat ='Farley'
// assign the string "San Francisco" to city I want to do a different city
...
if ( rentCost + utilitiesCost + foodCost + computerCost < budget) {
    sum = rentCost + utilitiesCost + foodCost + computerCost;
...
if ((rentCost > (utilitiesCost + foodCost + transportationCost)) && 
  (computerCost > (rentCost + utilitiesCost))) {
    alert("Computer costs are too high! Build your own");
  } else {
    alert ("Rent is too high! Move to Montana!");
  }
